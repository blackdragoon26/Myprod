...
- If Nomad ACLs were bootstrapped during an interrupted setup but no local token was saved, the bootstrap script uses Nomad's reset-index recovery flow to create and store a fresh management token.
